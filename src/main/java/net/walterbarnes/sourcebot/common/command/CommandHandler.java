...
{
	private final List<String> commandQueue = Collections.synchronizedList(new ArrayList<>());
	...
	private boolean registerCommand(@Nonnull String identifier, @Nonnull ICommand cmd)
	{
	...
	public void addPendingCommand(@Nonnull String command)
	{
	...
	private void executeCommand(@Nonnull String input)
	{
